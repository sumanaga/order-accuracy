...
| Service | Image |
|---------|-------|
| order-accuracy | `intel/order-accuracy-take-away:2026.0-rc2` |
| frame-selector | `intel/order-accuracy-frame-selector:2026.0-rc2` |
| gradio-ui | `intel/order-accuracy-take-away-ui:2026.0-rc2` |
| rtsp-streamer | `intel/order-accuracy-take-away-rtsp:2026.0-rc1` |
